...
mkdir -p ${GDATARR6DIR}
cd archive
rsync --include '*/' --exclude 'ocean_daily_3d_wt.nc' --include 'ocean_daily_3d_*.nc' --exclude '*' --exclude "*.nc.*" --exclude "*ocean_*_3hourly*" --exclude "*iceh_03h*" -vrltoD --safe-links output* ${GDATARR6DIR}
