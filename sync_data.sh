...
SYNCDIR=/g/data/v45/aek156/outputs/access-om2-01/01deg_jra55v140_iaf_cycle4_rerun_from_2002

exitcode=0
help=false
dirtype=output
exclude="--exclude *.nc.* --exclude iceh.????-??-??.nc --exclude iceh_03h*.????-??-??-[0-9][0-9][0-9][0-9][0-9].nc --exclude *-DEPRECATED --exclude *-DELETE --exclude *-IN-PROGRESS"
