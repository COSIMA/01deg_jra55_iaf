...
#PBS -l ncpus=1
#PBS -l wd
#PBS -l walltime=48:00:00,mem=12GB
#PBS -l storage=gdata/hh5+gdata/ik11+scratch/v45+scratch/x77+scratch/g40+gdata/cj50
#PBS -N sync_ik11
...
SYNCDIR=/g/data/cj50/access-om2/raw-output/access-om2-01/01deg_jra55v140_iaf

exitcode=0
help=false
dirtype=output
exclude="--exclude *.nc.* --exclude iceh.????-??-??.nc --exclude *-DEPRECATED --exclude *-DELETE --exclude *-IN-PROGRESS --exclude *ty_trans_int_z*"
...
cd /g/data/ik11/outputs/access-om2-01/01deg_jra55v140_iaf || exit 1
